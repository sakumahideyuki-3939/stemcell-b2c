...
<div class="algo-site">
    ...
    <section class="grid-row">
        ...
        <div class="u-unit h-960 bg-soft">
            <div class="inner-pad-center">
                <div class="addr-tag">ADDRESS: T2-3</div>
                <h2>生搾り（Lysate）という新しいアプローチ</h2>
                <p class="work-desc-rich">再生医療の現場では、「細胞移植（Cell Therapy）」への期待と、コストや定着率、そして腫瘍化リスクという課題がありました。一方で「培養上清液」は手軽ですが、細胞内部の成分は含まれていません。</p>
            </div>
        </div>
        <div class="u-unit h-960 bg-soft">
            <div class="inner-pad-center">
                ...
                <h2>細胞の中身を、丸ごと活かす。</h2>
                <p class="work-desc-rich">「幹細胞生搾り（濾液）」は、細胞そのものは含まず、細胞の中身（細胞質・オルガネラ成分）を含有する研究用試薬です。多種多様な成長因子やエクソソームを含有しており、複数の領域で特許を取得しています。関連する基礎研究データについては、<a href="./evidence.php" style="color:#2f2f2f; text-decoration:underline;">EVIDENCEページ</a>をご参照ください。</p>
            </div>
        </div>
    </section>
