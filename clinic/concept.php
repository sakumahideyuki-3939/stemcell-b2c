        ...
        <div class="container">
            ...
            <div class="intro-box">
                <div class="intro-text">
                    <p>再生医療の現場で広く使われてきた「幹細胞培養上清液」。それは、細胞を培養する過程で外へ分泌した成分のみを利用するものでした。しかし、細胞が持つ成分は、分泌されるものだけではありません。</p>
                    <p>私たちがたどり着いたのは、<strong>「幹細胞そのものを物理的に破砕し、中身を丸ごと抽出する」</strong>というアプローチです。これを私たちは『幹細胞生搾り（Stem Cell Lysate / FADRCL）』と名付けました。</p>
                    <p>従来の手法では回収されていなかった細胞内部の成分。それらを抽出し、かつリスクとなる細胞核をフィルターで除去する。それが、私たちの特許技術に基づく抽出アプローチです。</p>
                </div>
            ...
            <table class="comparison-table">
                <tr>
                    ...
                    <td>
                        ...
                        <p class="comp-desc">
                            製法：幹細胞を凍結融解や超音波で物理的に破壊し、精密濾過を行う特許取得済みの抽出技術。<br>
                            成分：分泌物に加え、細胞質・細胞内小器官の有用タンパク質も高濃度に含有。<br>
                            特徴：複数領域で基礎研究データが報告されています。ヒトでの臨床的有効性は未確認です。
                        </p>
                    </td>
                </tr>
            </table>
            ...
            <div class="container">
                ...
                <div class="ingredient-grid">
                    ...
                    <div class="ing-card">
                        ...
                        <p class="ing-desc">細胞膜やカルシウムシグナルに関わるタンパク質。基礎研究レベルでの報告があります。ヒトへの作用は未確認です。</p>
                    </div>
            ...
            <div class="container">
                ...
                <div class="safety-grid">
                    <div class="safety-item">
                        ...
                        <h4>細胞核の除去</h4>
                        <p>0.2μmの特殊フィルターにより、細胞核（DNA）を物理的に除去。細胞移植に伴うリスク要因が設計上排除されています。ただし、安全性を保証するものではありません。</p>
                    </div>
