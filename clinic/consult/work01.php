<?php
$work_id = 1;
$work_page_title = '幹細胞由来成分とは？はじめての方への全体像';
$work_lead = '幹細胞由来成分に興味はある。けれど、情報が多すぎて「どこから見ればいいか分からない」。このページは、期待を過度に膨らませるためではなく、あなたが納得して相談・受診に進めるように、判断材料を整えるための入口です。';
ob_start(); ?>

<h2>このサイトの役割</h2>
<p>
  当サイトは、幹細胞由来成分を用いたクリニック選びを検討する方が「納得して選べる状態」に近づくための情報整理サイトです。
...
<ul>
  <li><strong>「1回で効果が出る」</strong> — 多くの場合、複数回の施術を前提とした設計です。1回で顕著な結果を期待すると、個人差により判断を誤りやすくなります。</li>
