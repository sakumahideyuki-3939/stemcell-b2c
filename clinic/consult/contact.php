...
/* ====== 設定 ====== */
$ADMIN_NOTIFY_EMAIL = 'lab@algo-cosme.com';
$ADMIN_FROM_EMAIL   = 'lab@algo-cosme.com';
$SITE_NAME          = 'ALGO LAB';
...
$page_title = '無料相談フォーム';
$page_description = '幹細胞由来成分を用いた施術についての無料相談フォーム。匿名での相談も可能で、営業電話は一切ありません。約2分で情報整理を始められます。お気軽にご利用ください。';
?>
<!doctype html>
<html lang="ja">
<head>
      ...
      <form action="" method="post">
        ...
        <div class="step-panel" data-step="2">
          <div class="form-group">
            ...
            <div class="form-checkbox-group">
              <?php
                $purposes = ['ED','慢性痛','脳梗塞後遺症','AGA','美容エイジングケア','更年期','不妊・生殖医療について','その他'];
        ...
        <div class="step-panel" data-step="3">
          <div class="form-group">
            ...
            <textarea class="form-textarea" id="message" name="message" rows="6" placeholder="現在の症状や気になっていることがあればご記入ください。"><?php echo h($form['message']); ?></textarea>
          </div>
          <div class="form-group">
