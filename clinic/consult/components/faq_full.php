...
$faq_items = [
  ...
  [
    'q' => '家族が代理で相談できますか？',
    'a' => 'はい、歓迎しています。ご家族が代わりに情報収集されるケースも多くあります。一緒に整理しましょう。',
  ],
  [
    'q' => 'このサイトはクリニックですか？仲介業者ですか？',
    'a' => '医療機関ではありません。幹細胞由来成分の情報を整理し、ご相談者に合った提携クリニックを紹介するサービスです。ビジネスモデルを透明に開示しています。',
  ],
  [
    'q' => '幹細胞由来成分は本当に効果があるのですか？',
  ...
  [
    ...
    'a' => '個人差が大きく、お答えできません。回数・頻度については、提携クリニックで医師にご相談ください。',
  ],
  [
    'q' => '費用はどれくらいかかりますか？',
