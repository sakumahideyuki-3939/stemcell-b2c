...
/* ====== 設定（ここだけ調整） ====== */
$ADMIN_NOTIFY_EMAIL = 'celllab@algo-cosme.com';          // 運営側の受信先（法人問い合わせ）
$ADMIN_FROM_EMAIL   = 'celllab@algo-cosme.com';     // 送信元（あなたのドメイン推奨）
$SITE_NAME          = 'ALGO Inc.';
      ...
      <div style="height:480px; border-bottom:1px solid #f0f0f0;">
        <div class="inner-pad-center" style="justify-content:flex-start;">
          ...
          <div class="contact-info-block">
            ...
            <p>Email: celllab@algo-cosme.com / Tel: 03-6805-0781</p>
          </div>

          <div class="contact-info-block" style="margin-bottom:0;">
            <h3>メディア・講演依頼</h3>
            <p>取材・セミナー登壇・社内研修などのご依頼。</p>
            <p>Email: celllab@algo-cosme.com</p>
          </div>
        </div>
      </div>
